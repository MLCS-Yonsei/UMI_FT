...
from umi.real_world.bimanual_umi_env_noft import BimanualUmiNoFTEnv
            ...
            while True:
                ...
                try:
                    ...
                    while True:
                        ...
                        np_target_poses = np.array(this_target_poses)
                        print(f"target poses: {np_target_poses}")
                        env.exec_actions(
