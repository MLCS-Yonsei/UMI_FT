...
def main(input, output, tcp_offset, tx_slam_tag,
    ...
    for demo_idx, demo_data in enumerate(demo_data_list):
        ...
        for cam_idx, row in demo_video_meta_df.iterrows():
            ...
            save_path = f'gripper_ft_data_plot_{demo_idx}.png'
            plot_gripper_and_ft_data(video_timestamps=video_timestamps, 
                                 csv_timestamps=gripper_timestamps, 
...
def plot_gripper_and_ft_data(video_timestamps, csv_timestamps, gripper_width, i_gripper_width, Fx, i_Fx, Fy, i_Fy, Fz, i_Fz, Tx, i_Tx, Ty, i_Ty, Tz, i_Tz, save_path=None):
    ...
    plt.subplot(3, 1, 1)
    plt.plot(csv_timestamps, gripper_width, 'o-', label='Original Gripper Width')
    plt.plot(video_timestamps, i_gripper_width, 'o', label='Interpolated Gripper Width', markerfacecolor='none', markeredgecolor='blue')
    ...
    plt.subplot(3, 1, 2)
    plt.plot(csv_timestamps, Fx, 'r-', label='Original Fx')
    plt.plot(csv_timestamps, Fy, 'g-', label='Original Fy')
    plt.plot(csv_timestamps, Fz, 'b-', label='Original Fz')
    plt.plot(video_timestamps, i_Fx, 'o', label='Interpolated Fx',
             markerfacecolor='none', markeredgecolor='red')
    plt.plot(video_timestamps, i_Fy, 's', label='Interpolated Fy',
             markerfacecolor='none', markeredgecolor='green')
    plt.plot(video_timestamps, i_Fz, 'D', label='Interpolated Fz',
    ...
    plt.subplot(3, 1, 3)
    plt.plot(csv_timestamps, Tx, 'r-', label='Original Tx')
    plt.plot(csv_timestamps, Ty, 'g-', label='Original Ty')
    plt.plot(csv_timestamps, Tz, 'b-', label='Original Tz')
    plt.plot(video_timestamps, i_Tx, 'o', label='Interpolated Tx',
             markerfacecolor='none', markeredgecolor='red')
    plt.plot(video_timestamps, i_Ty, 's', label='Interpolated Ty',
             markerfacecolor='none', markeredgecolor='green')
    plt.plot(video_timestamps, i_Tz, 'D', label='Interpolated Tz',
             markerfacecolor='none', markeredgecolor='blue')
    plt.xlabel('Timestamp (s)')
