...
class TrainDiffusionUnetImageWorkspaceFTDepth(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        if cfg.policy.obs_encoder.model_rgb.pretrained:
            obs_encorder_lr *= 0.1
...
def main(cfg):
    workspace = TrainDiffusionUnetImageWorkspaceFTDepth(cfg)
    workspace.run()
