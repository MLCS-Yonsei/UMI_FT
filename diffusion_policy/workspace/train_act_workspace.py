...
from diffusion_policy.policy.act_policy import ACTPolicy
...
class TrainACTWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir = None):
        ...
        print(f'obs_encorder params: {len(obs_encorder_params)}') # TODO replace obs_encoder with ACT linear layers
        param_groups = [
