...
class TransformerForActionDiffusionFT(ModuleAttrMixin):
    def __init__(self,
        input_dim: int,
        output_dim: int,
        action_horizon: int,
        ...
        # SC: change n_emb to n_compress_emb for VTT
        n_emb = n_compress_emb
    ...
    def _init_weights(self, module):
        ...
        elif isinstance(module, TransformerForActionDiffusionFT):
