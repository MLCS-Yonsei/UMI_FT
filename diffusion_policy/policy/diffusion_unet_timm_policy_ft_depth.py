...
from diffusion_policy.model.vision.timm_obs_encoder_ft_depth import TimmObsEncoderFTDepth
from diffusion_policy.common.pytorch_util import dict_apply


class DiffusionUnetTimmPolicyFTDepth(BaseImagePolicy):
    def __init__(self, 
            shape_meta: dict,
            noise_scheduler: DDPMScheduler,
            obs_encoder: TimmObsEncoderFTDepth,
