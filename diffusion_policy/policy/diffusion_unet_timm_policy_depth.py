...
from diffusion_policy.model.vision.timm_obs_encoder_depth import TimmObsEncoderDepth
from diffusion_policy.common.pytorch_util import dict_apply


class DiffusionUnetTimmPolicyDepth(BaseImagePolicy):
    def __init__(self, 
            shape_meta: dict,
            noise_scheduler: DDPMScheduler,
            obs_encoder: TimmObsEncoderDepth,
