...
from diffusion_policy.model.diffusion.transformer_for_action_diffusion_ft import TransformerForActionDiffusionFT



class DiffusionTransformerTimmPolicyFT(BaseImagePolicy):
    def __init__(self, 
            shape_meta: dict,
        ...
        assert obs_shape[-1] == n_compress_emb
        obs_tokens = obs_shape[-2]
        
        model = TransformerForActionDiffusionFT(
    ...
    def predict_action(self, obs_dict: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        ...
        # process input
        obs_tokens = self.obs_encoder(nobs) # result of VTT Obs Encdoer
        # (B, N, n_emb)
