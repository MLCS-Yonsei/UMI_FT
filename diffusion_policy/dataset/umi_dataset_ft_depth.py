...
from diffusion_policy.common.sampler_ft_depth import SequenceSamplerFTDepth, get_val_mask
...
class UmiDatasetFTDepth(BaseDataset):
    def __init__(self,
        shape_meta: dict,
        dataset_path: str,
        ...
        sampler = SequenceSamplerFTDepth(
    ...
    def get_validation_dataset(self):
        ...
        val_set.sampler = SequenceSamplerFTDepth(
