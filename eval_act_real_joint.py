...
@click.option('-j', '--is_joint', default = False, type=bool, help='Whether joint or eef pose')
def main(input, output, robot_config, 
    ...
    no_mirror, sim_fov, camera_intrinsics, mirror_swap, zarr_path, replay, normalizer_path, is_joint):
    ...
    with SharedMemoryManager() as shm_manager:  
        with KeystrokeCounter() as key_counter, \
            ...
            with torch.no_grad():
                ...
                action = get_real_umi_action(action, obs, action_pose_repr, is_joint)
                ...
                try:
                    ...
                    # for t in range(100):
                        ...
                        with torch.no_grad():
                            ...
                            action = get_real_umi_action(raw_action, obs, action_pose_repr, is_joint=is_joint)
